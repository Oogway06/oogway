...
const sms = (conn, m) => {
	...
	if (m.message) {
		...
		if (m.msg) {
			...
			m.body = (m.type === 'conversation') ? m.msg : (m.type === 'extendedTextMessage') ? m.msg.text : (m.type == 'imageMessage') && m.msg.caption ? m.msg.caption : (m.type == 'videoMessage') && m.msg.caption ? m.msg.caption : (m.type == 'templateButtonReplyMessage') && m.msg.selectedId ? m.msg.selectedId : (m.type == 'buttonsResponseMessage') && m.msg.selectedButtonId ? m.msg.selectedButtonId : (m.type == 'listResponseMessage') && m.msg.singleSelectReply ? m.msg.singleSelectReply.selectedRowId : ''
	...
	m.reply = (teks = '', option = {id, mentions, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { text: teks, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyS = (stik, option = { id, mentions, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { sticker: stik, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyImg = (img, teks, option = { id, mentions, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyVid = (vid, teks, option = { id, mentions, gif, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { video: vid, caption: teks, gifPlayback: option.gif ? option.gif : false, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyAud = (aud, option = { id, mentions, ptt, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { audio: aud, ptt: option.ptt ? option.ptt : false, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyDoc = (doc, option = { id, mentions, filename, mimetype, quoted }) => conn.sendMessage(option.id ? option.id : m.chat, { document: doc, mimetype: option.mimetype ? option.mimetype : 'application/pdf', fileName: option.filename ? option.filename : 'undefined.pdf', contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
