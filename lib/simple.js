...
const sms = (conn, m) => {
	...
	m.reply = (teks = '', id = m.chat, option = { mentions: [m.sender], q = m }) => conn.sendMessage(id, { text: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
	m.replyS = (stik, id = m.chat, option = { mentions: [m.sender], q = m }) => conn.sendMessage(id, { sticker: stik, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
	m.replyImg = (img, teks, id = m.chat, option = { mentions: [m.sender], q = m }) => conn.sendMessage(id, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
	m.replyVid = (vid, teks, id = m.chat, option = { mentions: [m.sender], gif: false, q = m }) => conn.sendMessage(id, { video: vid, caption: teks, gifPlayback: option.gif, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
	m.replyAud = (aud, id = m.chat, option = { mentions: [m.sender], ptt: false, q = m }) => conn.sendMessage(id, { audio: aud, ptt: option.ptt, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
	m.replyDoc = (doc, id = m.chat, option = { mentions: [m.sender], filename: 'undefined.pdf', mimetype: 'application/pdf', q = m }) => conn.sendMessage(id, { document: doc, mimetype: option.mimetype, fileName: option.filename, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.q })
