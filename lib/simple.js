...
const sms = (conn, m) => {
	...
	m.replyDoc = (doc, info, id, mention) => conn.sendMessage(id ? id : m.chat, { document: doc, mimetype: info.mime ? info.mime : 'application/pdf', fileName: info.name ? info.name : 'undefined.pdf', contextInfo: { mentionedJid: mention ? mention : [m.sender] } }, { quoted: m }))
