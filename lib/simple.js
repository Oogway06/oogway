...
const sms = (conn, m) => {
	...
	m.reply = (teks = '', id = m.chat, option = { mentions: [m.sender], quoted: m }) => conn.sendMessage(id, { text: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyS = (stik, id = m.chat, option = { mentions: [m.sender], quoted: m }) => conn.sendMessage(id, { sticker: stik, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyImg = (img, teks, id = m.chat, option = { mentions: [m.sender], quoted: m }) => conn.sendMessage(id, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyVid = (vid, teks, id = m.chat, option = { mentions: [m.sender], gif: false, quoted: m }) => conn.sendMessage(id, { video: vid, caption: teks, gifPlayback: option.gif, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyAud = (aud, id = m.chat, option = { mentions: [m.sender], ptt: false, quoted: m }) => conn.sendMessage(id, { audio: aud, ptt: option.ptt, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyDoc = (doc, id = m.chat, option = { mentions: [m.sender], filename: 'undefined.pdf', mimetype: 'application/pdf', quoted: m }) => conn.sendMessage(id, { document: doc, mimetype: option.mimetype, fileName: option.filename, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
