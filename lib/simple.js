...
const sms = (conn, m) => {
	...
	m.replyVid = (vid, teks, gif, id, mention) => conn.sendMessage(id ? id : m.chat, { video: vid, caption: teks, gifPlayback: gif ? gif : false, contextInfo: { mentionedJid: mention ? mention : [m.sender] } }, { quoted: m })
	m.replyAud = (aud, ptt, id, mention) => conn.sendMessage(id ? id : m.chat, { audio: aud, ptt: ptt ? ptt : false, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: mention ? mention : [m.sender] } }, { quoted: m })
	m.replyDoc = (doc, info, id, mention) => conn.sendMessage(id ? id : m.chat, { document: doc, mimetype: info.mimetype ? info.mimetype : 'application/pdf', fileName: info.filename ? info.filename : 'undefined.pdf', contextInfo: { mentionedJid: mention ? mention : [m.sender] } }, { quoted: m })
