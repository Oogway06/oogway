...
const sms = (conn, m) => {
	...
	m.replyImg = (img, teks, option = { id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
	m.replyVid = (vid, teks, option = { id: m.chat, mentions: [m.sender], gif: false, quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { video: vid, caption: teks, gifPlayback: option.gif ? option.gif : false, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : m })
