...
const sms = (conn, m) => {
	...
	m.reply = (teks, id, option) => conn.sendMessage(id ? id : m.chat, { text: teks, contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
	m.replyS = (stik, id, option) => conn.sendMessage(id ? id : m.chat, { sticker: stik, contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
	m.replyImg = (img, teks, id, option) => conn.sendMessage(id ? id : m.chat, { image: img, caption: teks, contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
	m.replyVid = (vid, teks, id, option) => conn.sendMessage(id ? id : m.chat, { video: vid, caption: teks, gifPlayback: option.gif ? option.gif : false, contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
	m.replyAud = (aud, id, option) => conn.sendMessage(id ? id : m.chat, { audio: aud, ptt: option.ptt ? option.ptt : false, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
	m.replyDoc = (doc, id, option) => conn.sendMessage(id ? id : m.chat, { document: doc, mimetype: option.mimetype ? option.mimetype : 'application/pdf', fileName: option.filename ? option.filename : 'undefined.pdf', contextInfo: { mentionedJid: option.mention ? option.mention : [m.sender] } }, { quoted: m })
