...
const sms = (conn, m) => {
	...
	m.reply = (teks = '', option = {id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id, { text: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyS = (stik, option = { id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id, { sticker: stik, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyImg = (img, teks, option = { id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyVid = (vid, teks, option = { id: m.chat, mentions: [m.sender], gif: false, quoted: m }) => conn.sendMessage(option.id, { video: vid, caption: teks, gifPlayback: option.gif, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyAud = (aud, option = { id: m.chat, mentions: [m.sender], ptt: false, quoted: m }) => conn.sendMessage(option.id, { audio: aud, ptt: option.ptt, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
	m.replyDoc = (doc, option = { id: m.chat, mentions: [m.sender], filename: 'undefined.pdf', mimetype: 'application/pdf', quoted: m }) => conn.sendMessage(option.id, { document: doc, mimetype: option.mimetype, fileName: option.filename, contextInfo: { mentionedJid: option.mentions } }, { quoted: option.quoted })
