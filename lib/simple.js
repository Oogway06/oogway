...
const sms = (conn, m) => {
	...
	m.replyS = (stik, id, option = { mentions: [m.sender] }) => conn.sendMessage(id ? id : m.chat, { sticker: stik, contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
	m.replyImg = (img, teks, id, option = { mentions: [m.sender] }) => conn.sendMessage(id ? id : m.chat, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
	m.replyVid = (vid, teks, id,  option  = { mentions: [m.sender], gif = false }) => conn.sendMessage(id ? id : m.chat, { video: vid, caption: teks, gifPlayback: option.gif, contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
	m.replyAud = (aud, id, option = { mentions: [m.sender], ptt: false }) => conn.sendMessage(id ? id : m.chat, { audio: aud, ptt: option.ptt, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
	m.replyDoc = (doc, id, option = { mentions: [m.sender], filename: 'undefined.pfd', mimetype: 'application/pdf' }) => conn.sendMessage(id ? id : m.chat, { document: doc, mimetype: option.mimetype, fileName: option.filename, contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
