...
const sms = (conn, m) => {
	...
	m.replyDoc = (doc, id = m.chat, option = { mentions: [m.sender], filename: 'undefined.pfd', mimetype: 'application/pdf' }) => conn.sendMessage(id, { document: doc, mimetype: option.mimetype, fileName: option.filename, contextInfo: { mentionedJid: option.mentions } }, { quoted: m })
