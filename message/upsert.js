...
inky.groupParticipantsUpdate(v.chat, [mentionUser[0]], 'promote')
	.then(v.reply(`Ha sido promovido a @${mentionUser[0].split('@')[0]} como administrador por @${senderNumber}`, v.chat, [mentionUser[0], v.sender]))
	.catch(e => v.reply(e))
break
...
inky.groupParticipantsUpdate(v.chat, [mentionUser[0]], 'demote')
	.then(v.reply(`Ha sido removido a @${mentionUser[0].split('@')[0]} como administrador por @${senderNumber}`, v.chat, [mentionUser[0], v.sender]))
	.catch(e => v.reply(e))
break
...
inky.groupParticipantsUpdate(v.chat, [mentionUser[0]], 'remove')
	.then(v.reply(`Ha sido eliminado @${mentionUser[0].split('@')[0]} del grupo por @${senderNumber}`, v.chat, [mentionUser[0], v.sender]))
	.catch(e => v.reply(e))
break
